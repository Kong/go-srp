...
func (c *SRPClient) SetB(Bb []byte) error {
	...
	S, err := clientGetS(c.Params, c.Multiplier, c.X, c.Secret1, B, u)
...
func (c *SRPClient) ComputeM1() ([]byte, error) {
	if c.M1 == nil {
		return nil, errors.New("Incomplete protocol")
	}
...
func clientGetS(params *SRPParams, k, x, a, B, u *big.Int) ([]byte, error) {
